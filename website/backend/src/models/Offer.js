...
const schema = new mongoose.Schema(
  {
    ...
    discountPercentage: Number, imageUrls: [String], cardDesign: { templateId: String, templateVersion: Number, templateSource: String, previewUrl: String, canvas: mongoose.Schema.Types.Mixed, dynamicFields: mongoose.Schema.Types.Mixed, avatarId: String, primaryColor: String, secondaryColor: String, layout: String, customizations: mongoose.Schema.Types.Mixed, titleFontSize: Number, descriptionFontSize: Number, fontWeight: String, fontStyle: String, textAlign: String }, startsAt: Date, expiresAt: Date, address: String,
