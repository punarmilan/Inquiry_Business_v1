...
router.delete('/cities/:id', validate(schemas.deleteById), controller.deleteCity);
...
router.post('/workers/demo', validate(schemas.demoWorkersCreate), controller.createDemoWorkers);
router.post('/workers/dummy-numbers', validate(schemas.dummyProviderNumbers), controller.setDummyProviderNumbers);
router.put('/workers/:id', validate(schemas.workerUpdate), controller.updateWorker);
router.delete('/workers/:id', validate(schemas.deleteById), controller.deleteWorker);
...
router.delete('/service-categories/:id', validate(schemas.deleteById), controller.deleteServiceCategory);
...
router.delete('/businesses/:id', validate(schemas.deleteById), controller.hardDeleteBusiness);
...
router.delete('/offers/:id', validate(schemas.deleteById), controller.hardDeleteOffer);
...
router.delete('/template-assets/:id', validate(schemas.templateAssetDelete), controller.deleteTemplateAsset);
...
router.delete('/plans/:id', validate(schemas.deleteById), controller.deletePlan);
