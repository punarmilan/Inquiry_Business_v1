...
router.delete('/cities/:id', validate(schemas.idParams), controller.deleteCity);
...
router.delete('/workers/:id', validate(schemas.idParams), controller.deleteWorker);
...
router.delete('/service-categories/:id', validate(schemas.idParams), controller.deleteServiceCategory);
...
router.delete('/plans/:id', validate(schemas.idParams), controller.deletePlan);
