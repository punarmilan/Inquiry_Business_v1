...
export const ProviderApplicationsPage = () => {
  ...
  const approveApplication = (id: string) => {
    ...
    approve.mutate({ id, password }, { onSuccess: () => toast.success('Provider verified and login created.'), onError: (e: any) => toast.error(e.response?.data?.error?.message || 'Verification failed.') });
  };
  ...
  return <div className="space-y-6">
    <PageHeader title="Provider Applications" description="Review applications, verify providers, and create their provider login." />
