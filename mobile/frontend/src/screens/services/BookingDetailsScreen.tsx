...
const styles = createThemedStyles((c) => ({
  ...
  top: { height: 64, backgroundColor: c.surface, flexDirection: 'row', alignItems: 'center' },
  back: { width: 52, height: 52, alignItems: 'center', justifyContent: 'center' },
  topTitle: { ...theme.typography.h3, color: c.text },
  number: { ...theme.typography.tiny, color: c.textMuted },
  content: { padding: 18, paddingBottom: 100, gap: 12 },
  statusCard: { padding: 20, borderRadius: 20, backgroundColor: c.secondary },
  ...
  status: { ...theme.typography.h2, color: c.textInverse, textTransform: 'capitalize' },
  ...
  stepDone: { backgroundColor: c.primary, borderColor: c.primary },
  line: { flex: 1, height: 2, backgroundColor: '#8BC8C2' },
  lineDone: { backgroundColor: c.primary },
  info: { flexDirection: 'row', gap: 12, padding: 15, backgroundColor: c.surface, borderRadius: 16, borderWidth: 1, borderColor: c.border },
  flex: { flex: 1 },
  infoLabel: { ...theme.typography.caption, color: c.textMuted },
  infoValue: { ...theme.typography.bodyBold, color: c.text, marginTop: 3, textTransform: 'capitalize' },
  workerCard: { flexDirection: 'row', alignItems: 'center', gap: 11, padding: 15, backgroundColor: c.secondaryLight, borderRadius: 18 },
  workerAvatar: { width: 50, height: 50, borderRadius: 16, backgroundColor: c.surface, alignItems: 'center', justifyContent: 'center' },
  workerLabel: { ...theme.typography.tiny, color: c.textMuted },
  workerName: { ...theme.typography.bodyBold, color: c.text, marginTop: 2 },
  workerRating: { ...theme.typography.caption, color: c.accentDark, marginTop: 2 },
  connectionActions: { backgroundColor: c.primaryLight, borderRadius: 18, padding: 15 },
  connectionTitle: { ...theme.typography.bodyBold, color: c.text },
  connectionText: { ...theme.typography.caption, color: c.textSecondary, marginTop: 3 },
  connectionButtons: { flexDirection: 'row', gap: 9, marginTop: 12 },
  connectionButton: { flex: 1, paddingHorizontal: 8 },
  waiting: { flexDirection: 'row', gap: 12, padding: 17, backgroundColor: c.accentLight, borderRadius: 18 },
  waitTitle: { ...theme.typography.bodyBold, color: c.text },
  waitText: { ...theme.typography.caption, color: c.textSecondary, marginTop: 3 },
  ratingCard: { backgroundColor: c.surface, borderRadius: 20, padding: 18, borderWidth: 1, borderColor: c.accent, shadowColor: c.shadow, shadowOpacity: 1, shadowRadius: 9, shadowOffset: { width: 0, height: 4 }, elevation: 2 },
  ratingHeader: { flexDirection: 'row', alignItems: 'center', gap: 11 },
  ratingIcon: { width: 43, height: 43, borderRadius: 14, backgroundColor: c.accentLight, alignItems: 'center', justifyContent: 'center' },
  ratingTitle: { ...theme.typography.h3, color: c.text },
  ratingHint: { ...theme.typography.caption, color: c.textSecondary, marginTop: 3 },
  stars: { flexDirection: 'row', justifyContent: 'center', gap: 8, marginTop: 16 },
  starButton: { padding: 2 },
  commentInput: { minHeight: 82, textAlignVertical: 'top', borderWidth: 1, borderColor: c.border, borderRadius: 14, padding: 12, color: c.text, marginTop: 14, marginBottom: 13, ...theme.typography.caption },
  ratedCard: { flexDirection: 'row', alignItems: 'center', gap: 10, padding: 15, backgroundColor: c.successLight, borderRadius: 17 },
  ratedTitle: { ...theme.typography.bodyBold, color: c.text },
  ratedText: { ...theme.typography.caption, color: c.textSecondary, marginTop: 3 },
  paymentLocked: { flexDirection: 'row', alignItems: 'center', gap: 8, padding: 13, backgroundColor: c.accentLight, borderRadius: 14 },
  paymentLockedText: { flex: 1, ...theme.typography.caption, color: c.textSecondary },
}));
