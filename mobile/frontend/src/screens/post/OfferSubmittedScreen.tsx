...
const styles = createThemedStyles((c) => ({ container: { justifyContent: 'center', alignItems: 'center', padding: 28 }, icon: { width: 108, height: 108, borderRadius: 36, backgroundColor: c.successLight, alignItems: 'center', justifyContent: 'center' }, title: { ...theme.typography.h1, color: c.text, marginTop: 22 }, body: { ...theme.typography.body, color: c.textSecondary, textAlign: 'center', lineHeight: 22, marginTop: 8 }, button: { marginTop: 28 } }));
