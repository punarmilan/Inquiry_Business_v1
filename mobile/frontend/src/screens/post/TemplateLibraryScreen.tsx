...
import { OFFER_CARD_TEMPLATES, resolveOfferFontFamily, resolveOfferLineHeight, resolveTemplatePreviewText, resolveTemplateImageValue, findOfferAvatar, toOfferCardTemplate, type OfferCardDesign, type OfferCardTemplate, type OfferTemplateCanvas, type OfferTemplateElement } from '../../config/offerCardDesigner';
...
const LibraryCanvasThumb: React.FC<{ template?: OfferCardTemplate; design?: OfferCardDesign }> = ({ template, design }) => {
  ...
  const renderElement = (element: OfferTemplateElement) => {
    ...
    const text = resolveTemplatePreviewText(element.text || element.content || '', element.field || element.key, values);
    if (!text) return null;
...
const styles = createThemedStyles((c) => ({
  container: { backgroundColor: c.background }, flex: { flex: 1 }, topBar: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 14, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: c.border, backgroundColor: c.surface }, backButton: { width: 40, height: 40, alignItems: 'center', justifyContent: 'center' }, title: { ...theme.typography.h2, color: c.text }, subtitle: { ...theme.typography.caption, color: c.textMuted, marginTop: 2 }, content: { padding: 16, paddingBottom: 30, gap: 20 }, section: { gap: 10 }, blankSection: { gap: 10 }, sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, sectionTitle: { ...theme.typography.bodyBold, color: c.text }, seeAll: { ...theme.typography.caption, color: c.primary, fontWeight: '900' }, row: { gap: 10, paddingRight: 12 }, card: { width: 118, paddingBottom: 2 }, thumbnail: { width: 118, height: 158, overflow: 'hidden', borderRadius: 14, borderWidth: 1, borderColor: c.border, backgroundColor: c.surface, shadowColor: c.shadowStrong, shadowOpacity: 0.08, shadowRadius: 6, shadowOffset: { width: 0, height: 3 }, elevation: 2 }, thumbnailImage: { width: '100%', height: '100%' }, thumbnailFallback: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 10 }, fallbackText: { ...theme.typography.tiny, color: c.primaryDark, fontWeight: '900', textAlign: 'center', marginTop: 7 }, cardName: { ...theme.typography.caption, color: c.text, fontWeight: '800', marginTop: 7 }, cardCategory: { ...theme.typography.tiny, color: c.textMuted, marginTop: 2 }, loading: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 8 }, emptySection: { gap: 8 }, emptyText: { ...theme.typography.caption, color: c.textMuted }, error: { flexDirection: 'row', alignItems: 'center', gap: 8, padding: 12, borderRadius: 12, backgroundColor: c.dangerLight }, errorText: { flex: 1, ...theme.typography.caption, color: c.danger }, retry: { ...theme.typography.caption, color: c.primary, fontWeight: '900' }, modalBackdrop: { flex: 1, justifyContent: 'flex-end', backgroundColor: 'rgba(15,23,42,0.35)' }, actionSheet: { padding: 16, paddingBottom: 28, borderTopLeftRadius: 24, borderTopRightRadius: 24, backgroundColor: c.surface }, sheetHandle: { width: 38, height: 4, alignSelf: 'center', borderRadius: 2, backgroundColor: c.border, marginBottom: 14 }, sheetTitle: { ...theme.typography.h3, color: c.text }, sheetSubtitle: { ...theme.typography.caption, color: c.textMuted, marginTop: 2, marginBottom: 14 }, primarySheetAction: { minHeight: 48, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, borderRadius: 12, backgroundColor: c.primary, marginBottom: 8 }, primarySheetText: { ...theme.typography.bodyBold, color: c.textInverse }, sheetAction: { minHeight: 46, flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 10 }, sheetActionText: { ...theme.typography.body, color: c.text },
}));
