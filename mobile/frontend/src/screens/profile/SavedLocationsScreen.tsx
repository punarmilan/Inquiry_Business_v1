...
const styles = createThemedStyles((c) => ({
  header: { height: 58, flexDirection: 'row', alignItems: 'center', backgroundColor: c.surface, borderBottomWidth: 1, borderBottomColor: c.divider },
  back: { width: 54, height: 54, alignItems: 'center', justifyContent: 'center' },
  title: { ...theme.typography.h3, color: c.text },
  content: { flex: 1, padding: 18 },
  sectionLabel: { ...theme.typography.tiny, color: c.textMuted, fontWeight: '900', letterSpacing: 1.1, marginBottom: 9 },
  card: { flexDirection: 'row', alignItems: 'center', gap: 13, padding: 17, borderRadius: 19, borderWidth: 1, borderColor: c.border, backgroundColor: c.surface, marginBottom: 9 },
  activeCard: { borderColor: c.primary, backgroundColor: c.primaryLight },
  iconWrap: { width: 50, height: 50, borderRadius: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: c.primaryLight },
  copy: { flex: 1 },
  locationName: { ...theme.typography.bodyBold, color: c.text },
  locationMeta: { ...theme.typography.caption, color: c.textSecondary, marginTop: 3 },
  locationSource: { ...theme.typography.tiny, color: c.textMuted, marginTop: 5 },
  help: { ...theme.typography.caption, color: c.textSecondary, lineHeight: 19, marginTop: 12 },
  center: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 30 },
  emptyIcon: { width: 78, height: 78, borderRadius: 24, alignItems: 'center', justifyContent: 'center', backgroundColor: c.primaryLight },
  emptyTitle: { ...theme.typography.h2, color: c.text, marginTop: 18, textAlign: 'center' },
  emptyText: { ...theme.typography.body, color: c.textSecondary, textAlign: 'center', lineHeight: 22, marginTop: 7, marginBottom: 7 },
  primaryAction: { minHeight: 52, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, alignSelf: 'stretch', marginTop: 18, paddingHorizontal: 20, borderRadius: 26, backgroundColor: c.primary },
  primaryActionText: { ...theme.typography.button, color: c.textInverse },
  deleteAction: { minHeight: 50, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7, marginTop: 9 },
  deleteActionText: { ...theme.typography.bodyBold, color: c.danger },
}));
