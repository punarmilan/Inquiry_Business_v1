...
const styles = createThemedStyles((c) => ({ top: { height: 58, backgroundColor: c.surface, flexDirection: 'row', alignItems: 'center' }, back: { width: 52, height: 52, alignItems: 'center', justifyContent: 'center' }, title: { ...theme.typography.h3, color: c.text }, content: { flexGrow: 1, padding: 20 }, photoLabel: { ...theme.typography.bodyBold, color: c.text, textAlign: 'center', marginBottom: 10 }, photoPicker: { alignSelf: 'center', position: 'relative', marginBottom: 8 }, photoEdit: { position: 'absolute', right: 0, bottom: 0, width: 34, height: 34, borderRadius: 17, alignItems: 'center', justifyContent: 'center', backgroundColor: c.primary, borderWidth: 3, borderColor: c.surface }, photoHint: { ...theme.typography.caption, color: c.textSecondary, textAlign: 'center', marginBottom: 22 }, hint: { ...theme.typography.caption, color: c.textSecondary, marginBottom: 18 } }));
