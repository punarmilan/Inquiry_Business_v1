...
const styles = createThemedStyles((c) => ({
  top: { minHeight: 70, flexDirection: 'row', alignItems: 'center', backgroundColor: c.surface, paddingRight: 14, borderBottomWidth: 1, borderBottomColor: c.divider }, back: { width: 52, height: 52, alignItems: 'center', justifyContent: 'center' }, flex: { flex: 1 }, title: { ...theme.typography.h2, color: c.text }, subtitle: { ...theme.typography.tiny, color: c.textSecondary, marginTop: 2 }, add: { width: 42, height: 42, borderRadius: 21, backgroundColor: c.primaryLight, alignItems: 'center', justifyContent: 'center' }, content: { padding: 18, paddingBottom: 120, gap: 13 }, card: { backgroundColor: c.surface, borderRadius: 20, padding: 17, borderWidth: 1, borderColor: c.border, shadowColor: c.shadow, shadowOpacity: 1, shadowRadius: 10, shadowOffset: { width: 0, height: 5 }, elevation: 3 }, row: { flexDirection: 'row', alignItems: 'center', gap: 12 }, logo: { width: 52, height: 52, borderRadius: 17, backgroundColor: c.primaryLight, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }, logoImage: { width: '100%', height: '100%' }, name: { ...theme.typography.h3, color: c.text }, category: { ...theme.typography.caption, color: c.textSecondary, marginTop: 2 }, status: { ...theme.typography.tiny, color: c.warning, fontWeight: '900', textTransform: 'uppercase' }, statusApproved: { color: c.success }, address: { ...theme.typography.body, color: c.textSecondary, marginTop: 14 }, note: { ...theme.typography.caption, color: c.textSecondary, backgroundColor: c.secondaryLight, borderRadius: 10, padding: 10, marginTop: 12 }, plan: { flexDirection: 'row', gap: 10, alignItems: 'center', backgroundColor: c.accentLight, borderRadius: 14, padding: 12, marginTop: 14 }, planName: { ...theme.typography.bodyBold, color: c.text }, planDate: { ...theme.typography.caption, color: c.textSecondary, marginTop: 2 }, actions: { flexDirection: 'row', gap: 9, marginTop: 14 }, actionButton: { flex: 1, paddingHorizontal: 9 }, empty: { alignItems: 'center', padding: 30, backgroundColor: c.surface, borderRadius: 20, borderWidth: 1, borderColor: c.border }, emptyTitle: { ...theme.typography.h3, color: c.text, marginTop: 10 }, emptyText: { ...theme.typography.body, color: c.textSecondary, textAlign: 'center', lineHeight: 21, marginTop: 6 }, emptyButton: { marginTop: 17 },
}));
