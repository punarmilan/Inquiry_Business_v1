...
const styles = createThemedStyles((c) => ({
  ...
  row: { flexDirection: 'row', alignItems: 'flex-start', gap: theme.spacing.sm, padding: theme.spacing.sm, marginBottom: theme.spacing.sm, borderRadius: theme.radius.lg, borderWidth: 1, borderColor: c.border, backgroundColor: c.surface },
  icon: { width: 42, height: 42, borderRadius: theme.radius.md, alignItems: 'center', justifyContent: 'center', backgroundColor: c.primaryLight },
  copy: { flex: 1 },
  type: { ...theme.typography.bodyBold, color: c.text },
  order: { ...theme.typography.caption, color: c.textSecondary, marginTop: 3 },
  date: { ...theme.typography.tiny, color: c.textMuted, marginTop: 3 },
  amountWrap: { alignItems: 'flex-end' },
  amount: { ...theme.typography.bodyBold, color: c.text },
  status: { ...theme.typography.tiny, color: c.primaryDark, marginTop: 4, textAlign: 'right' },
  center: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: theme.spacing.xl },
  emptyTitle: { ...theme.typography.bodyBold, color: c.text, marginTop: theme.spacing.sm },
  errorText: { ...theme.typography.caption, color: c.danger, textAlign: 'center', marginTop: theme.spacing.xs },
  retry: { marginTop: theme.spacing.md, paddingHorizontal: theme.spacing.lg, paddingVertical: theme.spacing.sm, borderRadius: theme.radius.pill, backgroundColor: c.primary },
  retryText: { ...theme.typography.bodyBold, color: c.textInverse },
}));
