...
const styles = createThemedStyles((c) => ({
  ...
  heading: { ...theme.typography.bodyBold, color: c.text },
  subheading: { ...theme.typography.caption, color: c.textSecondary, marginTop: 3, maxWidth: 245 },
  count: { backgroundColor: c.primaryLight, borderRadius: 99, paddingHorizontal: 9, paddingVertical: 5 },
  countText: { ...theme.typography.tiny, color: c.primaryDark, fontWeight: '900' },
  categoryRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 7, marginBottom: 12 },
  categoryChip: { borderWidth: 1, borderColor: c.border, borderRadius: 99, paddingHorizontal: 11, paddingVertical: 6, backgroundColor: c.surface },
  categoryChipSelected: { borderColor: c.primary, backgroundColor: c.primaryLight },
  categoryChipText: { ...theme.typography.tiny, color: c.textSecondary, fontWeight: '800' },
  categoryChipTextSelected: { color: c.primaryDark },
  customModeCard: { flexDirection: 'row', alignItems: 'center', gap: 9, backgroundColor: c.primaryLight, borderRadius: 14, padding: 13, marginBottom: 16 },
  customModeCopy: { flex: 1 },
  customModeTitle: { ...theme.typography.bodyBold, color: c.primaryDark },
  customModeText: { ...theme.typography.caption, color: c.textSecondary, marginTop: 3 },
  ...
  previewCategory: { fontSize: 10, letterSpacing: 0.9, color: c.textInverse, fontWeight: '900' },
  ...
  previewTitle: { fontSize: 23, lineHeight: 27, fontWeight: '900', color: c.textInverse },
  previewDescription: { marginTop: 6, fontSize: 13, lineHeight: 17, color: 'rgba(255,255,255,0.94)', fontWeight: '600' },
  previewPrice: { marginTop: 14, fontSize: 17, color: c.textInverse, fontWeight: '900' },
  ...
  label: { ...theme.typography.bodyBold, color: c.text, marginBottom: 9, marginTop: 4 },
  controlHint: { ...theme.typography.caption, color: c.textMuted, marginBottom: 8, marginTop: -5 },
  optionRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 9 },
  optionTile: { minHeight: 38, minWidth: 88, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: c.border, borderRadius: 11, paddingHorizontal: 11, backgroundColor: c.surface },
  alignTile: { minHeight: 38, flexDirection: 'row', alignItems: 'center', gap: 6, borderWidth: 1, borderColor: c.border, borderRadius: 11, paddingHorizontal: 11, backgroundColor: c.surface },
  optionTileSelected: { borderColor: c.primary, backgroundColor: c.primaryLight },
  optionText: { ...theme.typography.caption, color: c.textSecondary, fontWeight: '800' },
  ...
  templateTile: { width: '48%', alignItems: 'center', padding: 7, borderRadius: 13, borderWidth: 1, borderColor: c.border, backgroundColor: c.surface },
  templateTileSelected: { borderColor: c.primary, backgroundColor: c.primaryLight },
  ...
  templateName: { width: '100%', fontSize: 12, lineHeight: 16, color: c.textSecondary, textAlign: 'left', marginTop: 7, fontWeight: '800', minHeight: 32 },
  templateNameSelected: { color: c.primaryDark },
  layoutGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 16 },
  layoutTile: { width: '48%', minHeight: 56, borderWidth: 1, borderColor: c.border, borderRadius: 12, paddingHorizontal: 11, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: c.surface },
  layoutTileSelected: { borderColor: c.primary, backgroundColor: c.primaryLight },
  layoutName: { ...theme.typography.caption, color: c.textSecondary, fontWeight: '800' },
  layoutNameSelected: { color: c.primaryDark },
  avatarGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 16 },
  avatarTile: { width: 58, height: 58, borderRadius: 12, overflow: 'hidden', borderWidth: 2, borderColor: c.border, backgroundColor: c.surfaceAlt },
  avatarTileSelected: { borderColor: c.primary, backgroundColor: c.primaryLight },
  avatarCheck: { position: 'absolute', right: 2, bottom: 2, width: 17, height: 17, borderRadius: 9, alignItems: 'center', justifyContent: 'center', backgroundColor: c.primary },
  colorRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  colorTile: { width: 34, height: 34, padding: 3, borderRadius: 17, borderWidth: 2, borderColor: 'transparent' },
  colorTileSelected: { borderColor: c.text },
  colorSwatch: { flex: 1, borderRadius: 99 },
  disabledTile: { opacity: 0.55 },
  rulesCard: { backgroundColor: c.primaryLight, borderRadius: 14, padding: 12, marginBottom: 16 },
  rulesHeader: { flexDirection: 'row', alignItems: 'center', gap: 7 },
  rulesTitle: { ...theme.typography.bodyBold, color: c.primaryDark },
  rulesHint: { ...theme.typography.caption, color: c.textSecondary, marginTop: 4 },
  ...
  ruleText: { ...theme.typography.tiny, color: c.primaryDark, fontWeight: '800' },
  ruleTextLocked: { color: c.textMuted },
}));
