...
export const MainTabNavigator: React.FC = () => {
  ...
  return <Tab.Navigator screenOptions={{ headerShown: false, tabBarActiveTintColor: theme.colors.primary, tabBarInactiveTintColor: '#8A9094', tabBarStyle, tabBarLabelStyle: styles.label, tabBarButton: (props) => <TabBarButton {...props} /> }}>
    <Tab.Screen name="OffersTab" component={OffersNavigator} options={{ tabBarLabel: t('navOffers'), tabBarIcon: ({ color, size }) => <MaterialCommunityIcons name="tag-heart-outline" size={size} color={color} /> }} />
    <Tab.Screen name="ServicesTab" component={ServicesNavigator} options={{ tabBarLabel: t('navServices'), tabBarIcon: ({ color, size }) => <MaterialCommunityIcons name="tools" size={size} color={color} /> }} />
    ...
    <Tab.Screen name="MoreTab" component={MoreNavigator} options={{ tabBarLabel: t('navMore'), tabBarIcon: ({ color, size }) => <MaterialCommunityIcons name="dots-grid" size={size} color={color} /> }} />
    <Tab.Screen name="ProfileTab" component={ProfileNavigator} options={{ tabBarLabel: t('navProfile'), tabBarIcon: ({ color, size }) => <MaterialCommunityIcons name="account-circle-outline" size={size} color={color} /> }} />
  </Tab.Navigator>;
};
